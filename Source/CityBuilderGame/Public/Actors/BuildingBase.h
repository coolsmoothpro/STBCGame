...
UCLASS()
class CITYBUILDERGAME_API ABuildingBase : public AActor
{
	GENERATED_BODY()
...
public:
	...
	*/
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Placement System | Size ")
	int32 width_Cell = 1;
	/*
	...
	*/
	...
	float cell_size = __Grid_Size_Default;
	...
	*/
	void OnPlaced(class UPlacementComponent* PlacementComponentRef);
	/*
		called When this actor placed on world
		can be Implemented on Blueprint
	*/
